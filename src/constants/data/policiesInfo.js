...
+ * La fecha de pago depende de la reserva / producto seleccionado.
  ...
  cancelaciones: {
    ...
    link1: {
      ...
      text: "hasta 7 días antes",
    },
    link2: {
      title: "Reembolso Total",
      text: "hasta 24 horas antes",
    },
    link3: {
...
+ Asegúrate de revisar los detalles de tu reserva antes de completar la transacción, ya que las políticas de cancelación y reembolso pueden variar según la experiencia seleccionada.`,
  ...
  reembolso7dias: {
    ...
    content: `
+ Para obtener un reembolso completo, debes cancelar tu reserva al menos 7 días antes de la fecha de la experiencia.
...
+ Si cancelas con menos de 2 días completos de antelación a la hora de inicio de la experiencia, no se reembolsará el importe abonado.
  ...
  reembolso24horas: {
    title: "Reembolso Total hasta 24 horas antes",
    content: `
    + Para obtener un reembolso completo, debes cancelar al menos 24 horas antes de la fecha/hora de inicio de la experiencia.
...
+ No se aceptarán cambios realizados con menos de 24 horas de antelación a la fecha/hora de inicio de la experiencia.
  ...
  noReembolsable: {
    title: "No reembolsable",
    content: `
    Estas experiencias no son reembolsables y no se pueden cambiar por ningún motivo. Si cancelas o pides una modificación, no se reembolsará el importe abonado.
    `,
  },
};
